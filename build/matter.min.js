...
;var i=e("./Pair"),r=e("../core/Common");!function(){o.create=function(e){return r.extend({table:{},list:[],collisionStart:[],collisionActive:[],collisionEnd:[]},e)},o.update=function(e,t,n){var o,r,s,a,l=e.list,c=e.table,d=e.collisionStart,u=e.collisionEnd,p=e.collisionActive,f=new Set;for(d.length=0,u.length=0,p.length=0,a=0;a<t.length;a++)o=t[a],o.collided&&(r=i.id(o.bodyA,o.bodyB),f.add(r),s=c[r],s?(s.isActive?p.push(s):d.push(s),i.update(s,o,n)):(s=i.create(o,n),c[r]=s,d.push(s),l.push(s)));for(a=0;a<l.length;a++)s=l[a],s.isActive&&!f.has(s.id)&&(i.setActive(s,!1,n),u.push(s))},o.removeOld=function(e,t){var n,o,i,r,s=e.list,a=e.table,l=[];for(r=0;r<s.length;r++)n=s[r],o=n.collision,o.bodyA.isSleeping||o.bodyB.isSleeping?n.timeUpdated=t:t-n.timeUpdated>1e3&&l.push(r);for(r=0;r<l.length;r++)i=l[r]-r,n=s[i],delete a[n.id],s.splice(i,1)},o.clear=function(e){return e.table={},e.list.length=0,e.collisionStart.length=0,e.collisionActive.length=0,e.collisionEnd.length=0,e}}()},{
